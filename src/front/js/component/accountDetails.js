...
export const AccountDetails = () => {
  ...
  console.log("Account details:", store.account_details);
  ...
  return (
    <>
      <Container className="center-container">
        <Row>
          <div
            className="center-item-container accountBalance"
            style={{ display: "flex", justifyContent: "space-between" }}
          >
            <span className="mb-3">{account?.account_type}</span>
            <div
              className={
                account?.balance > 0
                  ? "accountBalance green-numbers"
                  : "accountBalance red-numbers"
              }
            >
